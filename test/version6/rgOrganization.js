...
const RGAccount = artifacts.require('./RGAccountPrototype_v6.sol');
const RGOrganizationFactory = artifacts.require('./RGOrganizationFactory.sol');
const RGOrganization = artifacts.require('./RGOrganizationPrototype_v6.sol');
...
contract('RGOrganization v6', function(accounts) {
  ...
  before('setup others', function() {
   ...
   .then(contracts => {
     rgTransactionRulesRouter = contracts.router;
