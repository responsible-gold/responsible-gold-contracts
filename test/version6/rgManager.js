...
const RGManager = artifacts.require('./RGManagerPrototype_v6.sol');
const RGAssetOwnershipCardCloneFactory = artifacts.require('./RGAssetOwnershipCardCloneFactory.sol');
const RGAssetOwnershipCard = artifacts.require('./RGAssetOwnershipCardPrototype_v6.sol');
const RGTransactionRules = artifacts.require('./RGTransactionRulesPrototype_v6.sol');
const ownedBase = require('../ownedBase');
const deployHelperContracts = require('../helpers/deployHelperContracts');

contract('RGManager v6', function(accounts) {
