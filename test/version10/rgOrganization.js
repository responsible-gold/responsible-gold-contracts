...
const RGAccount = artifacts.require('./RGAccountPrototype_v10.sol');
const RGOrganizationFactory = artifacts.require('./RGOrganizationFactory.sol');
const RGOrganization = artifacts.require('./RGOrganizationPrototype_v10.sol');
...
contract('RGOrganization v10', function(accounts) {
