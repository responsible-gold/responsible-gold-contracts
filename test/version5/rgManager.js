...
const RGManager = artifacts.require('./RGManagerPrototype_v5.sol');
const RGAssetOwnershipCardCloneFactory = artifacts.require('./RGAssetOwnershipCardCloneFactory.sol');
const RGAssetOwnershipCard = artifacts.require('./RGAssetOwnershipCardPrototype_v5.sol');
const RGTransactionRules = artifacts.require('./RGTransactionRulesPrototype_v5.sol');
const ownedBase = require('../ownedBase');
const deployHelperContracts = require('../helpers/deployHelperContracts');

contract('RGManager v5', function(accounts) {
