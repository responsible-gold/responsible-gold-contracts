...
contract RGAssetOwnershipCardPrototype_v2 is ERC20, OwnedPrototype {
    ...
    function RGAssetOwnershipCardPrototype_v2() {
    ...
    /**
     * Migrate to new string type of Chip
     *
     * @param _chip new string chip
     *
     */
    function migrationSetChip(string _chip) onlyRGManager() returns(bool) {
        chip = _chip;
        return true;
    }
}