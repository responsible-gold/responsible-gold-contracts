...
import {RGAssetOwnershipCardPrototype_v4 as RGAssetOwnershipCard} from './RGAssetOwnershipCardPrototype_v4.sol';
 ...
 * didn't happen yet.
 */
contract RGManagerPrototype_v4 is ERC20, OwnedPrototype {
    ...
    function RGManagerPrototype_v4() {
